  ...
  return (
    <section className="rv-20-contact_main_section">
        ...
        <DivAnimateYAxis className="row">
          <div className="col-md-12 col-lg-5">
            <div className="rv-20-contact_image">
              <img src="/estudiosapp/assets/img/contact/home-6-1.png" alt="image" />
            </div>
          </div>
      ...
      <span className="home-6-sh-1">
        <img src="/estudiosapp/assets/img/contact/home-6-sh-1.png" alt="image" />
      </span>
      <span className="home-6-sh-2">
        <img src="/estudiosapp/assets/img/contact/home-6-sh-2.png" alt="image" />
      </span>
    </section>
  );
};
