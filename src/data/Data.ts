...
const serviceData2 = [
  {
    ...
    description:
      "Arquitectura, migración y administración sobre AWS, Azure y GCP. Entornos estables, monitoreados y con costos bajo control.",
    slug: "cloud-e-infraestructura",
    icon: Icon,
  ...
  },
  {
    ...
    description:
      "Aplicaciones web, portales y sistemas internos construidos sobre tus procesos reales, no sobre una plantilla genérica.",
  ...
  },
  {
    ...
    description:
      "Agentes que atienden consultas, clasifican información y responden 24/7, integrados a los canales que ya usás.",
  ...
  },
  {
    ...
    description:
      "Conectamos sistemas, CRM y fuentes de datos para que la información se cargue una sola vez y circule sola.",
...
const caseStudyData = [
  ...
  },
  {
    ...
    subTitle: "Cloud",
    title: "Migración e infraestructura gestionada",
    desc: "Entornos migrados y administrados con monitoreo, respaldo y costos previsibles.",
  },
  {
    id: 3,
    img: "assets/img/banners/Home_Header.png",
    ...
    desc: "Desarrollo de sistemas propios con la lógica de negocio del cliente, no de un producto enlatado.",
  },
  {
    id: 4,
    img: "assets/img/banners/Home_Header.png",
    ...
    title: "Integración de sistemas y reportes",
    desc: "Datos que se sincronizan solos entre plataformas y reportes que se arman sin planillas manuales.",
  },
];
